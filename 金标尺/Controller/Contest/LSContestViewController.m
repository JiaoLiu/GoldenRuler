...
@interface LSContestViewController ()
{
    LSExam *exam;
...
@implementation LSContestViewController
...
- (void)initExamView
{
    ...
    float height = (oframe.origin.y + oframe.size.height) > self.view.bounds.size.height ? (oframe.origin.y + oframe.size.height) : self.view.bounds.size.height;
...
{
    [self clearAllView];
    NSString *title = @"题目：题目内容是什么东西？到了恩阳古镇不可错过的当然就是“恩阳十大碗”，每一碗都是肉劲十足。";
    ...
    cms.content = @"题目：题目内容是什么东西？恩阳古镇 ；雨中的恩阳古镇更显古朴宁静，到了恩阳，每一碗都是肉劲十足。";
    LSComments *cms2 = [[LSComments alloc]init];
    cms2.username = @"jeanky wang";
    cms2.dateStr = @"2014-06-10";
    cms2.content = @"题目：题目内容是什么东西？恩阳古镇 ；雨中的恩阳古镇更显古朴宁，每一碗都是肉劲十足。";
    LSComments *cms3 = [[LSComments alloc]init];
    cms3.username = @"jeanky wang";
    cms3.dateStr = @"2014-06-10";
    cms3.content = @"题目：雨中的恩阳古镇更显古朴宁静，到了恩阳古镇不可错过的当然就是“恩阳十大碗”，每一碗都是肉劲十足。";
    ...
    CGRect tFrame = CGRectMake(0,
                               view.frame.origin.y + view.frame.size.height ,
                                                                SCREEN_WIDTH,
                               self.view.bounds.size.height - view.frame.origin.y - view.frame.size.height - 5 - tabBar.frame.size.height
                               );
